...
public class RestaurantServiceImpl implements RestaurantService {
    ...
    public void reserveInventory(OrderId orderId) {
        reservationProducer.sendMessage(restaurantRequestTopic, new ReserveInventoryCommand());
    }

    @Override
    public void cancelInventoryReservation(OrderId orderId) {
        cancelReservationCommandKafkaProducer.sendMessage(restaurantRequestTopic, new CancelReservationCommand());
    }
}
